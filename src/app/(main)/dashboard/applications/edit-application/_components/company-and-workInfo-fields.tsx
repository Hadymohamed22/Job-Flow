...
import WorkLocationSection from "./work-location-section";
...
type Props = {
  ...
  setValue: UseFormSetValue<EditApplicationFormFields>;
  companyImageUrl: string | undefined;
};

export default function CompanyAndWorkInfoFields({
  register,
  errors,
  setValue,
  companyImageUrl,
    ...
    <div className="company-and-role-fields flex flex-col gap-4 md:gap-6">
      ...
      <div className="company-image-upload">
        ...
        <div className="mb-4 flex flex-col items-center justify-center gap-2">
          ...
          {companyImageUrl ? (
            <div className="size-24 rounded-lg border border-[#4B5563] bg-[#181C26]/60 flex items-center justify-center p-2">
              <Image
                src={companyImageUrl}
        ...
        >
          {/* 
            IMPORTANT:
            If you want isDirty to reflect file input changes, always use setValue from react-hook-form to update your field, as react-hook-form does NOT track native uncontrolled file inputs by default.
            For drop, replace, remove, and change handlers, call setValue("company-image", file, { shouldDirty: true })
          */}
          <Input
            ref={fileInputRef}
            type="file"
            ...
            onChange={(e) => {
              handleInputChange(e);
              // IMPORTANT: tell react-hook-form that field is dirty
              if (e.target.files && e.target.files.length > 0) {
                setValue("company-image", e.target.files[0], {
                  shouldDirty: true,
                });
              }
            }}
              ...
              <div className="flex flex-wrap justify-center gap-2">
                ...
                <button
                  ...
                  onClick={(event: React.MouseEvent<HTMLButtonElement>) => {
                    event.stopPropagation();
                    handleRemoveImage();
                    setValue("company-image", undefined, {
                      shouldDirty: false,
                    });
                  }}
